...
export default function TitlebarImageList() {
  ...
  return (
    <ImageList variant="masonry" gap={18} cols={4} className='mt-10'>
      {itemData.map((item) => (
        <ImageListItem key={item.img} className=' cursor-pointer'>
          ...
          <div className='bg-dimSecondary w-[90%] border-2 border-primary rounded bottom-0 mx-[5%] mb-1 absolute flex flex-col justify-start items-left'>
            ...
            <Typography sx={{marginLeft: "0.5rem"}} className='w-[80%] line-clamp-3 text-white'>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.
            </Typography>
            <Typography sx={{marginLeft: "0.5rem"}} variant='h6' className=' truncate text-white'>User Name</Typography>
          </div>
        </ImageListItem>
      ))}
    </ImageList>
