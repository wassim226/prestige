...
import { Pool4, PureWater } from '../assets'
  ...
  return (
    <div className='flex flex-col justify-start items-center'>
        <div className='flex flex-row justify-center items-center w-[65vw] h-[80vh] my-5'>
            <img className='w-full h-full' src={Pool4}/>
        </div>
        <section className='flex flex-col justify-start items-center mx-32'>
            <Typography gutterBottom variant='h3' sx={{fontWeight: 550}} className='text-primary '>Lorem ipsum dolor sit amet</Typography>
            <Typography gutterBottom sx={{marginBottom:"35px"}} className='text-white'>
                {default_description}
                {default_description}
                {default_description}
                {default_description}
            ...
            <Typography gutterBottom variant='h5' className='text-primary text-left w-full'>Un sous titre</Typography>
